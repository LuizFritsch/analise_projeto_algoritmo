...
def main():
	...
	help_msg = "algoritmos (t=tsp naive, s=selection sort, i=insertion sort, r=reverse sort) ou nenhum para executar todos.  Padrão:{}".format(DEFAULT_ALGORITMOS)
	...
	experimentos = [TspNaive(args), SortSelection(args), SortInsertion(args), SortReverse(args)]
